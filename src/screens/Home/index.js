    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{
                ...
                <Text style={{marginTop:15,marginBottom:5, fontSize:17, fontSize:20, fontWeight:'bold', color:'#7E7E7E'}}>Colecionaveis</Text>
            ...
            <View style={{
                ...
                alignSelf:'center',
                  ...
                  <Text style={{marginTop:15, fontSize:17, fontSize:20, fontWeight:'bold', color:'#7E7E7E'}}>Top 10</Text>
